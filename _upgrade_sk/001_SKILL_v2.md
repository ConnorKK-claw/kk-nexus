...
aa0: 法规框架（证监会/国资委/财政部/交易所）
bb0: 操作实务（方案设计/定价/审批/披露/回购/行权）
dd0: 案例数据（公司案例/高管薪酬/考核数据）
gg0: 蒸馏知识（工具选择/国资专题/税务会计）
...
| 能力 | 对应节点 |
|------|---------|
| 股权激励方案设计（期权、限制性股票、员工持股计划） | gg0-0, gg0-3, bb0-0 |
| 国资监管法规检索与解读 | aa0-0 ~ aa0-4 |
| 税务筹划与合规分析 | bb0-2, gg0-8, gg0-33 |
| 同行业案例对标 | bb0-0, dd0-0 |
| 财务测算与考核指标设定 | dd, gg0-1, gg0-23 |
